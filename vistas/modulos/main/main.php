<main class="main__content_wrapper">
        ...
        <div class="container">
            <div class="hero__section--inner d-flex align-items-center">
                <div class="hero__thumbnail position__relative">
                    ...
                    <div class="projects__budget d-flex align-items-center">
                        ...
                        <div class="projects__budget--content">
                            <span class="projects__budget--ammount">1963k+</span>
                ...
                <div class="hero__content">
                    ...
                    <h2 class="hero__content--title mb-15">¡Jorge Chávez H.! </h2>
                    <h3 class="hero__content--subtitle2 mb-20">Desarrollador fullStack</h3>
                    <p class="hero__content--desc mb-30">Soy un desarrollador fullstack apasionado, con habilidades tanto en el front-end como en el back-end, creando soluciones web innovadoras.</p>
                    <div class="hero__content--footer d-flex align-items-center">
                        <a class="btn hero__content--btn" href="#">Acerca de mí</a>
            ...
            <div class="brand__section--inner">
                <div class="brand__logo--child">
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand1.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-1.png" alt="brand-logo">
                    </div>
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand2.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-2.png" alt="brand-logo">
                    </div>
                </div>
                <div class="brand__logo--child">
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand3.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-3.png" alt="brand-logo">
                    </div>
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand4.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-4.png" alt="brand-logo">
                    </div>
                </div>
                <div class="brand__logo--child">
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand5.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-5.png" alt="brand-logo">
                    </div>
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand6.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-6.png" alt="brand-logo">
                    </div>
                </div>
                <div class="brand__logo--child">
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand7.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-7.png" alt="brand-logo">
                    </div>
                    <div class="brand__logo--items">
                        <img class="brand__logo--img brand_logo_light" src="vistas/dist/main/assets/img/logo/brand8.png" alt="brand-logo">
                        <img class="brand__logo--img brand_logo_dark" src="vistas/dist/main/assets/img/logo/dark-log-8.png" alt="brand-logo">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="resume__step">
                        ...
                        <div class="resume__items--inner d-flex">
                            ...
                            <div class="resume__content">
                                <div class="resume__content--top d-flex align-items-center mb-10">
                                    <h3 class="resume__content--title">API DEVELOPER</h3>
                                    <span class="resume__content--subtitle">Shopify</span>
                                </div>
                                <p class="resume__content--desc mb-20">Promote your blog posts, case udie, and product ouncems nts with thehe branded videos.</p>
                                <span class="resume__date">2021</span>
                            </div>
                        </div>
                    </div>
                    <div class="resume__items">
                        ...
                        <div class="resume__items--inner d-flex">
                            ...
                            <div class="resume__content">
                                <div class="resume__content--top d-flex align-items-center mb-10">
                                    ...
                                    <span class="resume__content--subtitle">ENVATO</span>
                                </div>
                                <p class="resume__content--desc mb-20">Promote your blog posts, case udie, and product ouncems nts with thehe branded videos.</p>
                    ...
                    <div class="resume__items">
                        ...
                        <div class="resume__items--inner d-flex">
                            ...
                            <div class="resume__content">
                                <div class="resume__content--top d-flex align-items-center mb-10">
                                    <h3 class="resume__content--title">UI/UX DESIGNER</h3>
                                    <span class="resume__content--subtitle">UDEMY</span>
                                </div>
                                <p class="resume__content--desc mb-20">Promote your blog posts, case udie, and product ouncems nts with thehe branded videos.</p>
                                <span class="resume__date">2014</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="resume__step">
                    ...
                    <div class="resume__items">
                        ...
                        <div class="resume__items--inner d-flex">
                            ...
                            <div class="resume__content">
                                <div class="resume__content--top d-flex align-items-center mb-10">
                                    <h3 class="resume__content--title">Software Engineer</h3>
                                    <span class="resume__content--subtitle">CAMBRIDGE UNIVERSITY</span>
                                </div>
                                <p class="resume__content--desc mb-20">Promote your blog posts, case udie, and product ouncems nts with thehe branded videos.</p>
                ...
                <div class="portfolio__grid mb--n30">
                        ...
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio1.png" alt="img">
                                </div>
                    ...
                    <div class="element-item graphics" data-category="graphics">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio2.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item development" data-category="development">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio3.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item mobile" data-category="mobile">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio4.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item web" data-category="web">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio5.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item graphics" data-category="graphics">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio6.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item development" data-category="development">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio7.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item web" data-category="web">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio8.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
                    ...
                    <div class="element-item mobile" data-category="mobile">
                        <div class="portfolio__card">
                            <a href="#" class="popup-modal--open display-block" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                <div class="portfolio__image--card">
                                    <img src="vistas/dist/main/assets/img/other/portfolio9.png" alt="img">
                                </div>
                                <div class="portfolio__content">
                                    <span class="portfolio__zoom text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
    ...
    <section class="testimonial__section section--padding position__relative">
                        ...
                        <div class="testimonial__items text-center">
                            <div class="testimonial__content mb-30">
                                <ul class="rating__wrapper d-flex justify-content-center">
                                    <li class="rating__list"><span class="rating__icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="testimonial__author">
                                <img class="testimonial__author--media" src="vistas/dist/main/assets/img/other/testimonial-author-thumb.png" alt="img">
        ...
        <span class="testimonial__position--icon left">
            <svg width="260" height="260" fill="currentColor" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div class="modal-content modal-content-height">
            ...
            <div class="modal-body portfolio__modal--body">
                ...
                <div class="portfolio__modal--info__media">
                    <img src="vistas/dist/main/assets/img/other/portfolio-big1.png" alt="img">
                </div>
            </div>
        </div>
    </div>
